                    ...
                    <div class="row">
                        ...
                        <div className='signindiv'>
                            <form onSubmit={handleSubmit}>
                                ...
                                <input onChange={handleChange} name="email" type='text' placeholder='Enter email address' className='emailsignin'/>

                                <label className='loginemail'>Password</label>
                                
                                <input onChange={handleChange} name="password" type='password' placeholder='Enter password' className='emailsignin'/>
			...
			<div className="modal__container">
                ...
                <button className='closebutton' onClick={closeButton}>Close</button>
                    <div class="row">
                        ...
                        <input type='email' name='email' placeholder='Enter email address' value={formData.email} onChange={handleChange} className='emailsignin' required/>

                          <label className='loginemail'>Password</label>
                          
                          <input type='password' name='password' placeholder='Enter password' value={formData.password} onChange={handleChange}className='emailsignin' required/>
