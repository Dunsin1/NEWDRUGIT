...
//   console.log(myElement2);
  ...
  const DrugResult = drugdata.filter((drug) =>
   drug.interaction1[0].name1 === drugString && 
   drug.interaction2[0].name2 === drugString2 || 
   drug.interaction2[0].name2 === drugString && 
   drug.interaction1[0].name1 === drugString2
   )
  ...
  return (
    <div className='Banner'>
        ...
        <div className='Banner3'>
         ...
         {display && display === true? <Result DrugResult={DrugResult}/> :""}
